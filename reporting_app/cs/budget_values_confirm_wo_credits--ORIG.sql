with encumbrance_summary as (
	...
	where ftt.transaction_type = 'Encumbrance'
		AND ftt.fiscal_year_id = '31d90609-401e-4ee5-9884-cf728c2f648e'
	...
	where transaction_type = 'Pending payment'
		and fiscal_year_id = '31d90609-401e-4ee5-9884-cf728c2f648e'
	...
	coalesce(ps.p_amount,0) AS trans_exp,
	fb.id as budget_id
...
where fb.budget_status = 'Active'
	...
	OR fb.expenditures <> coalesce(ps.p_amount,0))
ORDER BY fb."name";
